    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        ...
        <form onSubmit={formik.handleSubmit}>
          ...
          <FormControl id="vacations" mb="4" isInvalid={!!formik.errors?.vacations}>
            <FormLabel>Vacations</FormLabel>
            <NumberInput
              name="vacations"
              value={formik.values?.vacations}
              onChange={(valueString, valueNumber) =>
                formik.setFieldValue('vacations', Number.isNaN(valueNumber) ? 0 : valueNumber)
              }
            >
              <NumberInputField />
              <NumberInputStepper>
            ...
            {formik.errors.vacations && <FormErrorMessage>{formik.errors?.vacations}</FormErrorMessage>}
          </FormControl>
